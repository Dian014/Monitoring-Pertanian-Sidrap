...
COLOR_PUTIH = "#ffffff"
COLOR_GELAP_LEMBUT = "#2e3440"  # Ganti hitam pekat dengan biru gelap lembut
COLOR_INPUT_GELAP = "#3b4252"   # Input lebih terang agar tidak gelap pekat
